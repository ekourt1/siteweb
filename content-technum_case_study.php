...
$read_more_text = ( isset($args['read_more_text']) ? $args['read_more_text'] : esc_html__('See Case Study', 'technum') );
$item_class     = 'grid-item grid-blog-item-wrapper' . ( isset($args['item_class']) ? ' ' . $args['item_class'] : '' );
$excerpt_length = ( isset($args['excerpt_length']) && !empty($args['excerpt_length']) ? $args['excerpt_length'] : technum_get_theme_mod('case_studies_archive_excerpt_length') );
$columns_number = ( isset($args['columns_number']) && !empty($args['columns_number']) ? $args['columns_number'] : technum_get_theme_mod('case_studies_archive_columns_number') );
?>
...
<div <?php post_class($item_class); ?>>
    <div class="blog-item">
        <?php
            ...
            if ( $show_cat == 'yes' && !empty(technum_case_studies_categories_output()) ) {
                ...
                if ( $show_tags == 'yes' && !empty(technum_case_studies_tags_output()) ) {
